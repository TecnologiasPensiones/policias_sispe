...
{
    public partial class frmrepocheques : Form
    {
        public frmrepocheques()
        {
            InitializeComponent();
        }
        ...
        {
            txtchequera.Text = "0139891689";
            txtchequera.Select();
            try
            {
                string query = "SELECT min(numcheque) as minimo , max(numcheque) as maximo FROM financieros.datoscheques";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "select cheques.folio,cheques.numcheque,cheques.concep1,cheques.fecha,cheques.reviso,cheques.autorizo,cheques.elaboro,cheques.numpoliz,detalle.debe_haber,detalle.importe,detalle.concepto,detalle.ctacontab,detalle.referencia,cheques.benefic,cheques.chequera,cheques.impcheque  from financieros.datoscheques cheques inner join financieros.detalle_cheque detalle on detalle.numcheque = cheques.numcheque where cheques.chequera='{0}' AND cheques.numcheque BETWEEN '{1}' and '{2}' order by cheques.numcheque desc,debe_haber asc,referencia desc";
